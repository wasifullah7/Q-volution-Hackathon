        ...
        <div className="flex flex-col">
          ...
          <div className="mb-16 w-full">
            ...
            <h2 className="max-w-[800px] text-[32px] font-bold leading-[1.2] tracking-[-0.03em] text-text-primary sm:text-[36px]">
              In South Carolina , there was an average of <span className="text-accent-primary">53 hours of blackouts</span> in 2024-
              nearly <span className="text-accent-primary underline">5x</span> the national average.
            </h2>
          </div>
          ...
          <div className="grid w-full gap-16 lg:grid-cols-[1.2fr_1fr] lg:items-start">
            ...
            <div className="space-y-10">
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 rounded-md bg-accent-primary px-6 py-3 text-[14px] font-bold text-bg-base transition-all hover:opacity-90"
              >
            ...
            <div className="relative flex flex-col items-center lg:items-end">
              <div className="w-full max-w-[400px]">
                ...
                />
                <p className="mt-4 text-[11px] text-text-tertiary text-center lg:text-right">
                  Source: <a href="https://felt.com/explore/us-electric-power-transmission-lines-south-carolina" target="_blank" rel="noopener noreferrer" className="underline cursor-pointer hover:text-text-secondary">US Electric Power Transmission Lines in South Carolina</a>
                </p>
              </div>
            </div>
          </div>
